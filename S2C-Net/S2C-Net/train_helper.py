...
class Trainer(object):
    ...
    def setup(self):
        args = self.args
        sub_dir = (
            "sam2/{}-input-{}_wot-{}_wtv-{}_reg-{}_nIter-{}_normCood-{}".format(
                args.run_name,
                args.crop_size,
                args.wot,
                args.wtv,
        ...
        self.save_dir = os.path.join("ckpt", sub_dir)
        ...
        if args.dataset.lower() == "tms":
            self.datasets = {
                ...
                "val": Crowd_TMS(
                    os.path.join(args.data_dir, "val_data"),
                    args.crop_size,
                    downsample_ratio,
                    "val",
                ),
        ...
        model = Model.S2C_Net(args.hiera_path)
        self.model = model
        ...
        if args.wandb:
            ...
            config=args, project="S2C-Net", name=args.run_name
        )
        else : 
